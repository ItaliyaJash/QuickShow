...
//             <img src={item.show.movie.poster_path} alt="" className='w-24 md:w-32 aspect-[3/4] h-auto object-cover object-top rounded' />
...
//               {!item.isPaid && (
//                 <button className='bg-primary px-4 py-1.5 text-sm rounded-full font-medium cursor-pointer text-white hover:bg-primary/90 transition-colors'>
//                   Pay Now
//                 </button>
//               )}
//             </div>
