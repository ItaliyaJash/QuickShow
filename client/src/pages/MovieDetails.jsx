...
function MovieDetails() {
    ...
    const getShow = async () => {
        ...
        if(show) {
            setShow({
                movie: show,
                dateTime: dummyDateTimeData // ← Fixed: Use consistent camelCase naming
            })
        }
    }
    ...
    console.log('dateTime data:', show?.dateTime)

    return show ? (
        <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
            <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'> {/* Fixed: flex-col to flex-row */}
            ...
            {/* Fixed: Now accessing the correct property name */}
        ...
        //     <div className="text-lg">Loading... <br /></div>
            <Loading />
        // {/* </div> */}
    )
}
